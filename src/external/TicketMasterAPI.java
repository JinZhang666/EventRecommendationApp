...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "6iWdNjVAZBgEJkioGHvd8a3dt8wMijR7";
	...
	public List<Item> search(double lat, double lon, String keyword) {
	 ...
	 //connection this server with api service 
	 try {
		...
		System.out.println("Rsposne code: " + responseCode);
